...
function App(props) {
  ...
  return (
    <div>
      <Box>
        <Input value={person1.name} onChange={handleNameChange} />
        <Text>이름 : {person1.name}</Text>

        <Input value={person1.city} onChange={handleCityChange} />
        <Text>도시 : {person1.city}</Text>

        <Input value={person1.email} onChange={handleEmailChange} />
